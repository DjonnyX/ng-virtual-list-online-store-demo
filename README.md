# NgVirtualList Online Store Demo

✨ NgVirtualList Online Store Demo (ng-virtual-list-online-store) is an Angular-based showcase application designed to demonstrate high-performance rendering of long message history using virtual scrolling techniques.
...
[Live Demo](https://online-store.eugene-grebennikov.pro/)
...
```bash
git clone https://github.com/DjonnyX/ng-virtual-list-online-store.git
cd ng-virtual-list-online-store
```
